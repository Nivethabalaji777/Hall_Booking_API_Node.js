...
app.get("/", (req, res) => {
  res.status(200).send("Hall Booking API by Nivetha is running successfully!");
});
...
app.get("/", (req, res) => {
  console.log("Hall Booking API by Nivetha is running successfully");
});
